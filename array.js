...
// ADDING ELEMENTS: push(), splice() and unshift()
        // const numbers = [3, 8, 9, 7, 2,1]; //all numbers start at index 0
// // items can be added from the front, middle or the end of the array
        // numbers.push(900);//push adds item to the end of the array
        // // console.log(numbers); //[3, 8, 9, 7, 2,1,900] 
        // numbers.unshift(22); //unshift adds item to the beginning of the array
        // // console.log(numbers); //[22, 3, 8, 9, 7, 2,1,900] 
        // numbers.splice(2, 2, 34, 44);// first 2 means start from index 2,
        //         //  second 2 means delete 2 items from list, 
        //         // next 2 numbers (34 , 44) are the numbers to replace the deleted numbers.
        // console.log(numbers); //[22, 3, 34, 44, 7, 2,1,900] 
...
// SORTING THRU STR AND ARRs:
        ...
        // console.log(reverseWords);//[ 'w', 't', 's', 'b', 'a' ]descending order
                ...
                //     optionA = a.name.tolowercase();
                //     optioB = b.name.toUppercase();

                //     if optionA < optioB return 1;
                //     if optionA > optioB return -1;
                //     return 0
